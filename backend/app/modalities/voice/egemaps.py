...
(carried over unchanged from the original Cadence research; see model.py for why).
"""
...
def egemaps_for_paths(paths: list[str], use_cache: bool = True, verbose: bool = True):
    """Cached (N, 88) eGeMAPS matrix + feature names. Used only by offline retraining."""
